      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-balance mb-4 sm:mb-6">
            <span className="text-red-400">Manual SEO</span> Analysis is Time-Consuming
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-white/70 max-w-3xl mx-auto font-light leading-relaxed">
            Checking hundreds of pages manually is inefficient. Here's how Contentlytics automates it all.
          </p>
        </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-red-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-red-400">Manual Approach</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-red-400 mb-2">40+ Hours</div>
                <p className="text-white/80 text-sm sm:text-base">
                  Average time to manually audit a large website with hundreds of pages
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-white/70 text-sm sm:text-base">
                    Manually checking each page for SEO issues
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">
                    Missing pages hidden in complex site structures
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-red-400 rounded-full mt-2 shrink-0"></div>
                  <p className="text-white/70 text-sm sm:text-base">No insight into AEO or AI bot accessibility</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="group">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-8 h-full hover:bg-white/10 transition-all duration-500 hover:border-green-400/30">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-green-400">Contentlytics</h3>
              </div>

              {/* Key Stat */}
              <div className="bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-xl p-4 sm:p-6 mb-6">
                <div className="text-3xl sm:text-4xl font-bold text-green-400 mb-2">Minutes</div>
                <p className="text-white/80 text-sm sm:text-base">
                  Crawl entire sites with unlimited depth and get comprehensive SEO/AEO reports
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Discovers all pages automatically via sitemap + crawling</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">AI-powered AEO analysis and Schema.org generation</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle />
                  <p className="text-white/70 text-sm sm:text-base">Performance audits, backlinks, and competitor insights</p>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            ...
            <p className="text-white/70 text-xs sm:text-sm">Concurrent crawling requests</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">10</div>
            <p className="text-white/70 text-xs sm:text-sm">Schema.org types supported</p>
          </div>
          <div className="text-center bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 sm:p-6 hover:bg-white/10 transition-all duration-300">
            <div className="text-2xl sm:text-3xl font-bold text-white mb-2">Unlimited</div>
            <p className="text-white/70 text-xs sm:text-sm">Crawl depth for full site coverage</p>
          </div>
        </div>
        ...
        >
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-4 text-balance">
            Start Your Website Analysis Today
          </h3>
          <p className="text-sm sm:text-base md:text-lg text-white/70 mb-6 sm:mb-8 max-w-2xl mx-auto font-light leading-relaxed">
            Get comprehensive SEO/AEO insights, performance audits, and AI-powered Schema generation in minutes.
          </p>
          <Button
            size="lg"
